# B09 - Unnamed building

![Unnamed building](img/B09_x6.png)
...
```
   ...
   y2 | D E | E E | E E | E E | E E | E D |
      ...
      +-----+-----+-----+-----+-----+-----+
   y3 | I J | J J | J K | K J | J J | J L |
      | I K | K K | K K | K K | K K | K L |
      +-----+-----+-----+-----+-----+-----+
   y4 | I K | K K | M N | J J | K K | K L |
...
```
   ...
   y2 |  90  18 |  18  18 |  18  18 |  18  18 |  18  18 |  18  90 |
      ...
      +---------+---------+---------+---------+---------+---------+
   y3 |  15  10 |  10  10 |  10  75 |  75  10 |  10  10 |  10  31 |
      |  15  75 |  75  75 |  75  75 |  75  75 |  75  75 |  75  31 |
      +---------+---------+---------+---------+---------+---------+
   y4 |  15  75 |  75  75 |  11  12 |  10  10 |  75  75 |  75  31 |
...
local rows = {
  ...
  {  15,  10,  10,  10,  10,  75,  75,  10,  10,  10,  10,  31 },  -- r5
  {  15,  75,  75,  75,  75,  75,  75,  75,  75,  75,  75,  31 },  -- r6
  {  15,  75,  75,  75,  11,  12,  10,  10,  75,  75,  75,  31 },  -- r7
  {  78,  26,  26,  26,  27,  28,  26,  26,  26,  26,  26,  79 },  -- r8
}
```
...
![distinct tiles](img/B09_atlas.png)
...
```
    ...
    y4   SOLID  SOLID  DOOR   SOLID  SOLID  SOLID
```
...
| --- | --- | --- | --- |
| CELADON_CITY | (26,16) | (28,19) | `GAME_CORNER` |
| CINNABAR_ISLAND | (4,0) | (6,3) | `POKEMON_MANSION_1F` |
| CINNABAR_ISLAND | (4,6) | (6,9) | `CINNABAR_LAB` |
| FUCHSIA_CITY | (16,0) | (18,3) | `SAFARI_ZONE_GATE` |
| FUCHSIA_CITY | (20,10) | (22,13) | `FUCHSIA_MEETING_ROOM` |
