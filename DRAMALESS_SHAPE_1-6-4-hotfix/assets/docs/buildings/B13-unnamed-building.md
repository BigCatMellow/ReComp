# B13 - Unnamed building

![Unnamed building](img/B13_x6.png)

`OVERWORLD` tileset, **6 x 4 cells** (12 x 8 tiles of 8px, 96 x 64 px). Appears **4 times** in the game. Tile ids index `assets/generated/tilesets/overworld.png`, 16 per row.
...
```
   ...
   y3 | I J | J J | J J | J J | J J | J K |
      ...
      +-----+-----+-----+-----+-----+-----+
   y4 | I L | L L | L L | L L | L L | L K |
      | M N | N N | N N | N N | N N | N O |
      +-----+-----+-----+-----+-----+-----+
```
...
![distinct tiles](img/B13_atlas.png)
...
| --- | --- | --- | --- |
| ROUTE_15 | (8,6) | - | scenery, no entrance |
| ROUTE_16 | (18,2) | - | scenery, no entrance |
| ROUTE_7 | (12,8) | - | scenery, no entrance |
| ROUTE_8 | (2,8) | - | scenery, no entrance |
